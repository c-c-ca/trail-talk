...
import styles from './AvailableSignUpMethodsForm.module.css';
...
class AvailableSignUpMethodsForm extends Component {
  ...
  renderDescription() {
    ...
    return (
      <div className={styles.AvailableSignUpMethodsFormDescription}>
        <p>
  ...
  render() {
    return (
      <div className={styles.AvailableSignUpMethodsForm}>
...
export default connect(null, actions)(AvailableSignUpMethodsForm);
